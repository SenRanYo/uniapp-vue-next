...
parser.prototype.popNode = function () {
    ...
    if ((attrs.class || '').includes('align-right')) styleObj['text-align'] = 'right'
    if ((attrs.class || '').includes('align-left')) styleObj['text-align'] = 'left'
    if ((attrs.class || '').includes('ql-indent-1')) styleObj['text-indent'] = '2em'
    if ((attrs.class || '').includes('ql-indent-2')) styleObj['text-indent'] = '4em'
